...
<head>
    ...
    <title>Registrants - Before Events</title>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Registrants Before Event</h4>
                            </div>
                            <div class="card-body">
                                <div class="d-flex">
                                    <a href="" class="ms-start mb-3" style="color: black">
                                        Total : <b>{{ $jml_registrasi_before }} </b> result(s)
                                        <button type="button" class="btn btn-info"> <i class="fe fe-sync"></i>
                                        </button>
                                    </a>
                                    <a href="{{ '/registrants-export' }}" class="ms-auto">
